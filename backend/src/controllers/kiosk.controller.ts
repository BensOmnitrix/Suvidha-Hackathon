...
const registerKiosk = asyncHandler(async (req: Request, res: Response) => {
...
// Update Kiosk Status
const updateKioskStatus = asyncHandler(async (req: Request, res: Response) => {
...
// Get all Kiosks
const getAllKiosks = asyncHandler(async (req: Request, res: Response) => {
