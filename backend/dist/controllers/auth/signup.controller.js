...
export async function signup(req, res) {
    const { mobileNumber, otp, citizenId, fullName, email, dateOfBirth, address, } = req.body;
    ...
    const session = await createUserSession(user.userId, req.ip, req.headers["user-agent"]);
